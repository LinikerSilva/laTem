...
$retorno = $databaseInstance1 -> query("SELECT P.nome AS nomeproduto, P.categoria, P.imagem_path, E.nome, E.rua, E.bairro, E.numero FROM produto P INNER JOIN empresa E ON p.empresa_fk = E.id_empresa WHERE P.categoria = 'Petshop'");
