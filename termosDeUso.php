...
<div class="classTexto"> 
<p>
    <h3 class="classTitle">
    Política Privacidade</h3>
<div>A sua privacidade é importante para nós. É política do Lá Tem respeitar a sua privacidade em relação a qualquer informação sua que possamos coletar no site Lá Tem, e outros sites que possuímos e operamos.<br><br>
...
O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não temos controle sobre o conteúdo e práticas desses sites e não podemos aceitar responsabilidade por suas respectivas <a href="termosDeUso.php"> políticas de privacidade.</a><br><br>

Você é livre para recusar a nossa solicitação de informações pessoais, entendendo que talvez não possamos fornecer alguns dos serviços desejados.

O uso continuado de nosso site será considerado como aceitação de nossas práticas em torno de privacidade e informações pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, entre em contato conosco.</div>

<h3>Política de Cookies Lá Tem</h3>
<h4 class="classSubtitle"> O que são cookies?</h4>
<div>Como é prática comum em quase todos os sites profissionais, este site usa cookies, que são pequenos arquivos baixados no seu computador, para melhorar sua experiência. Esta página descreve quais informações eles coletam, como as usamos e por que às vezes precisamos armazenar esses cookies. Também compartilharemos como você pode impedir que esses cookies sejam armazenados, no entanto, isso pode fazer o downgrade ou 'quebrar' certos elementos da funcionalidade do site.</div><br>

<h4>Como usamos os cookies?</h4>
<div>Utilizamos cookies por vários motivos, detalhados abaixo. Infelizmente, na maioria dos casos, não existem opções padrão do setor para desativar os cookies sem desativar completamente a funcionalidade e os recursos que eles adicionam a este site. É recomendável que você deixe todos os cookies se não tiver certeza se precisa ou não deles, caso sejam usados ​​para fornecer um serviço que você usa.</div>
...
<div>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Lá Tem oferece no site e com caráter enunciativo, mas não limitativo:</div>
...
<ul>
    ...
    <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Lá Tem, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
</ul>

<h4>Mais informações</h4>

<div>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.
</div>
    <div>Esta política é efetiva a partir de <b>Aug/2022.</b></div>
</p>
</div>
</body>
</html>